...
fluidRow(
h2("About the App"),
helpText("This Application was build to allow further exploration of the natural variation in Root System Architecture. 
The accompanying paper:",br(), br(), 
a("Genetic components of root architecture remodeling in response to salt", 
  href = "http://www.plantcell.org/content/early/2017/11/07/tpc.16.00680"), br(),
...
"Published in" a("Plant cell, DOI: https://doi.org/10.1105/tpc.16.00680", href="http://www.plantcell.org/content/early/2017/11/07/tpc.16.00680"), br(), br(),
