...
The App can be either accessed [here](http://genseq-h0.science.uva.nl/shiny/App/Salt_NV_Root/) or [here](https://mmjulkowska.shinyapps.io/Salt_NV_RootApp/) or run locally from your device by typing the following command in your R window:
